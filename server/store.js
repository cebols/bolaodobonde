...
function scoreMatch(pool, pred, m) {
  ...
  // home_score/away_score são SEMPRE o placar do tempo regulamentar (sem pênaltis).
  // No mata-mata, um empate aqui é um empate de verdade; quem passou está em m.advanced.
